...
public class WTScore implements Serializable {
	...
	public void setRating(int rating) {
		if (!((0 == rating) || (3 <= rating && rating <= 5)))
			throw new IllegalArgumentException("rating must be 0, 3, 4, or 5, was " + rating);
		this.rating = rating;
	}
	...
	public void setStreak(int streak) {
		if (streak < 0)
			throw new IllegalArgumentException("streak must not be negative, was " + streak);
		this.streak = streak;
	}
